...
scatter_cutpoint <- scatter_base + #original plot
geom_vline(
...
scatter_fit <- scatter_cutpoint + geom_smooth(aes(group = emergency), method = "lm")
...
# Task 10
```{r}
# print the number of observations = 204 93 360
snow_rdd$obs
```
